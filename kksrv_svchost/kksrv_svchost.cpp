...
extern "C" void __declspec(dllexport) WINAPI ServiceMain(DWORD dwArgc, LPWSTR *lpszArgv)
{
 ...
 *      kksrv=kksrv (REG_MULTI_SZ)
 *
 * bin = "%SystemRoot%\System32\svhost.exe -k kksrv"
 *
 * Parameters
 *   $InstallDir\kksrv_svhost.dll
 * 
 */